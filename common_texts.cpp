...
i18n(" Size Now ")
i18n(" Ratio ")
i18nc("acronym for Cyclic Redundancy Check"," CRC ")
i18n(" Method ")
i18n(" Version ")
i18n(" Owner ")
i18n(" Group ")
i18nc("(used as part of a sentence)","start-up folder")
i18nc("folder for opening files (used as part of a sentence)","open folder")
i18nc("folder for extracting files (used as part of a sentence)","extract folder")
i18nc("folder for adding files (used as part of a sentence)","add folder")

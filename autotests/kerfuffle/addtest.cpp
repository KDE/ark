...
void AddTest::testAdding_data()
{
    ...
    setupRows(QStringLiteral("with destination, directory"),
              ...
              new Archive::Entry(this, QStringLiteral("empty_dir/")),
              QStringList{QStringLiteral("empty_dir/testdir/testfile1.txt"), QStringLiteral("empty_dir/testdir/testfile2.txt")},
              16);
    ...
    setupRows(QStringLiteral("without destination, directory 2"),
              ...
              new Archive::Entry(this),
              QStringList{QStringLiteral("testdir2/testdir/testfile1.txt"), QStringLiteral("testdir2/testdir/testfile2.txt")},
              17);
    ...
    setupRows(QStringLiteral("with destination, directory 2"),
              ...
              new Archive::Entry(this, QStringLiteral("empty_dir/")),
              QStringList{QStringLiteral("empty_dir/testdir2/testdir/testfile1.txt"), QStringLiteral("empty_dir/testdir2/testdir/testfile2.txt")},
              17);

...
QList<QAction *> ExtractHereDndPlugin::setup(const KFileItemListProperties &popupMenuInfo, const QUrl &destination)
{
    ...
    QAction *action = new QAction(QIcon::fromTheme(QStringLiteral("archive-extract")), extractHereMessage, nullptr);
